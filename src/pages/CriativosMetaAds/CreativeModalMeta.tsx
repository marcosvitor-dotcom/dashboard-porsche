              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{formatNumber(creative.reach ?? 0)}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">{formatNumber(creative.pageEngagements ?? 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Visualizações 25%:</span>
                    <span className="font-semibold">{formatNumber(creative.videoWatches25 ?? 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Visualizações 50%:</span>
                    <span className="font-semibold">{formatNumber(creative.videoWatches50 ?? 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Visualizações 75%:</span>
                    <span className="font-semibold">{formatNumber(creative.videoWatches75 ?? 0)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Visualizações 100%:</span>
                    <span className="font-semibold">{formatNumber(creative.videoWatches100 ?? 0)}</span>
                  </div>
                </div>
              </div>
            </div>
